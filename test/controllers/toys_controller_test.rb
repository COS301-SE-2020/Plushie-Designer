...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post toys_url, params: { toy: { arms: @toy.arms, head: @toy.head, legs: @toy.legs, name: @toy.name, rating: @toy.rating, torso: @toy.torso } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { arms: @toy.arms, head: @toy.head, legs: @toy.legs, name: @toy.name, rating: @toy.rating, torso: @toy.torso } }
